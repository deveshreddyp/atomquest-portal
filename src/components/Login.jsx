...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh]">
      <div className="bg-white dark:bg-slate-900 p-10 rounded-2xl shadow-xl border border-border w-full max-w-md">
        <div className="text-center mb-8">
            <h2 className="text-3xl font-black text-slate-800 dark:text-white">Welcome Back</h2>
            <p className="text-slate-500 dark:text-slate-400 mt-2">Sign in to your AtomQuest account</p>
        </div>
